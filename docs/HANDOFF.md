...
- GateFlame disabled on the Pi 5 (user confirmed). Resume: `RESUME-GATEFLAME.cmd`.
- Pi display script ready: `SETUP-PI-LAB.cmd` (ASUS screen kiosk of the dashboard).
...
5. Move Pi 5 to H3C; run `SETUP-PI-LAB.cmd`; read `data\pi-lab-setup.log`.
